...
def run_kitti2bag():
    ...
    parser.add_argument("-c", "--compression", choices = compression_choices, help = "which compression to use for the created bag")
    args = parser.parse_args()

    bridge = CvBridge()
    compression = compression_choices[args.compression]
